...
<template>
	<a-spin :spinning="loading" wrapper-class-name="bookmark-overlay">
		<a-layout-sider :width="286" class="bookmark-sider">
			<a-layout-header class="sider-header">
				...
				<a-button @click="updateSort" class="sort-button">
					<plus-outlined stroke-width="90" stroke="currentColor" width="1.25rem" height="1.25rem" />
				</a-button>
			</a-layout-header>
			...
			<a-layout-header class="main-header">
				...
				<a-button-group class="bookmark-operation">
					...
					<a-button @click="updateFullScreen" class="bookmark-operation-button fullscreen-button">
						<handle-outlined width="1.25rem" height="1.25rem" />
					</a-button>
					<a-button @click="updateVisible" class="bookmark-operation-button close-button">
						<close-outlined width="1.25rem" height="1.25rem" />
					</a-button>
				</a-button-group>
			</a-layout-header>
