...
import ApplicationIcon from './app-markdown-icon.vue'
import ApplicationWindow from './app-markdown-window.vue'
...
<template>
	<div
		...
		:class="['app-markdown', application.size, application.shape, application.direction]"
	>
		<a-modal
			width="80%"
			:icon="null"
