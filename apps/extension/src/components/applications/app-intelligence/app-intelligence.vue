...
import ApplicationIcon from './app-intelligence-icon.vue'
import ApplicationWindow from './app-intelligence-window.vue'
...
<template>
	<div
		...
		:class="['app-intelligence', application.size, application.shape, application.direction]"
	>
		<a-modal
			width="80%"
			:icon="null"
