...
<template>
	<div class="app-intelligence-window">
		<div class="histories-area">
			<div class="histories">
				<div v-for="value in 30" :key="value" class="history">{{ value }}</div>
		...
		<div class="thinking-area">
			<div class="visual-area">
				<div class="visual">
					<div ref="sessionRef" class="session-area">
						{{ session }}
					</div>
				</div>
			</div>
