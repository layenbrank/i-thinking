...
import Marker from '@/components/magnetic-tiles/calendar/calendar-marker.vue'
import Overlay from '@/components/magnetic-tiles/calendar/calendar-overlay.vue'
...
<template>
  <div
    ...
    <a-modal
      ...
      class="magnetic-tile-overlay calendar-overlay">
      <Overlay
...
<style lang="scss">
.magnetic-tile-overlay.calendar-overlay {
  %size-full {
    width: 100%;
    height: 100%;
  }
