...
import Marker from '@/components/magnetic-tiles/clock/clock-marker.vue'
import Overlay from '@/components/magnetic-tiles/clock/clock-overlay.vue'
...
<template>
  <div
    ...
    <Modal
      ...
      class="magnetic-tile-overlay clock-overlay">
      <Overlay
...
<style lang="scss">
.magnetic-tile-overlay.clock-overlay {
  %size-full {
    width: 100%;
    height: 100%;
  }
