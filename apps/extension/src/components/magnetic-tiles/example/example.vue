...
import Marker from '@/components/magnetic-tiles/example/example-marker.vue'
import Overlay from '@/components/magnetic-tiles/example/example-overlay.vue'
...
<template>
  <div
    ...
    <Modal
      ...
      class="magnetic-tile-overlay example-overlay">
      <Overlay
...
<style lang="scss">
.magnetic-tile-overlay.example-overlay {
  %size-full {
    width: 100%;
    height: 100%;
  }
