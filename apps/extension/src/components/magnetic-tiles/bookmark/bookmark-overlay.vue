...
type Directory = MagneticTile.Bookmark.Directory
...
function updateApplication(bookmark: Entry) {
  ...
  try {
    void store.toInsertMagneticTile([
      {
        collectionID: null,
        id: raw.id,
        title: raw.title,
    ...
    console.error('Error updating magneticTile:', raw)
...
.bookmark-overlay {
  ...
  .bookmark-sider {
    ...
    border-top-left-radius: var(--magnetic-tile-global-overlay-round, 8px);
    border-bottom-left-radius: var(--magnetic-tile-global-overlay-round, 8px);
  ...
  .bookmark-main {
    ...
    border-top-right-radius: var(--magnetic-tile-global-overlay-round, 8px);
    border-bottom-right-radius: var(--magnetic-tile-global-overlay-round, 8px);
