...
.dock {
	@apply w-full h-full flex items-end justify-center;
	...
	.menu-item {
		@apply flex flex-col items-center justify-center rounded-xl bg-white bg-opacity-30 cursor-pointer text-white;
