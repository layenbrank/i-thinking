...
// export function useApplicationSettings(options: ApplicationSetting) {
// 	const direction = computed(function () {
// 		if (options.horizontal.value) return 'horizontal'
// 		else if (options.vertical.value) return 'vertical'
// 		else return 'horizontal'
// 	})

// 	const shape = computed(function () {
...
// 	const appStylesMap: ApplicationStyleMap = {
// 		mini: {
// 			circle: {
// 				horizontal: {
...
// 	const appStyle = computed(function () {
