...
export const ENV_TOKEN = new HttpContextToken<EnvURL | undefined>(
  () => undefined
)

export const THINKING_TOKEN = new HttpContext().set(ENV_TOKEN, 'thinking')

export const ENGINE_TOKEN = new HttpContext().set(ENV_TOKEN, 'engine')

export const INTELLIGENCE_TOKEN = new HttpContext().set(
  ENV_TOKEN,
  'intelligence'
)
