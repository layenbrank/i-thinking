...
import styles from '@/components/applications/developer/overlay.module.scss'
import {
	AppstoreOutlined,
	BarsOutlined,
	LikeOutlined,
...
const Overlay: FC<Props> = function (props) {
	...
	return (
		...
		>
			...
			<div className={clsx(styles.pane)}>
				...
				<Card variant="borderless" className={clsx(styles.panel)}>
						...
						renderItem={function (item) {
							return (
								<Entries.Item
									key={item.label}
									actions={[
										<EntriesMarker marker={StarOutlined} text="156" key="list-vertical-star-o" />,
										<EntriesMarker marker={LikeOutlined} text="156" key="list-vertical-like-o" />,
										<EntriesMarker marker={MessageOutlined} text="2" key="list-vertical-message" />
									]}
									extra={
										<img
											draggable={false}
