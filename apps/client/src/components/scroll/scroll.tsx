  ...
  X(props: XScrollProps) {
    ...
    return (
      <div
        ...
        className={clsx([props.className, props.classNames?.root, styles.scroll, styles.section])}>
        <div
          onScroll={props.onScroll}
          style={props.styles?.wrapper}
          className={clsx([props.classNames?.wrapper, styles.scroll, styles.wrapper])}>
          <div
            style={props.styles?.inner}
            className={clsx([props.classNames?.inner, styles.scroll, styles.inner])}>
            {props.children}
          </div>
        </div>
      </div>
