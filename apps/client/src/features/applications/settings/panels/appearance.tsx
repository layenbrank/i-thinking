...
import { exportAppearanceFile, importAppearanceFile } from '@/features/applications/settings/theme-io'
  ...
  return (
    <div className={styles.panel}>
      <div className={styles.grid}>
        ...
        <div className={clsx(styles.card, styles.previewSticky)}>
          <Typography.Text
            type="secondary"
            className={styles.cardTitle}>
            实时预览
