...
import styles from '@/features/applications/morph/morph.module.scss'

const Marker = lazy(function () {
  return import('@/features/applications/morph/marker.tsx')
})
const Overlay = lazy(function () {
  return import('@/features/applications/morph/overlay.tsx')
})
