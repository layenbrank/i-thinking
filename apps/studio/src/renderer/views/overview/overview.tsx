...
import { Input, Layout as Payload, FloatButton, Space, Button } from 'antd'
  ...
  return (
    <Payload className={clsx(styles.overview, styles.payload)}>
      <Prefix
        ...
        <div
          data-region="true"
          className={clsx([styles.utility, styles.final])}></div>
      </Prefix>
      <Core
        data-region="false"
        className={clsx(styles.overview, styles.core)}>
        <Controller.Mirror>
