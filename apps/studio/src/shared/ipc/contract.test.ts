...
type _StudioKeysMatch = AssertExtends<keyof Studio, StudioNamespace>
type _StudioKeysComplete = AssertExtends<StudioNamespace, keyof Studio>
type _ScreenshotOnlyCapture = AssertExtends<keyof Studio['screenshot'], 'capture'>
