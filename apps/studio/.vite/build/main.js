...
require$$3$1.app.on("window-all-closed", function() {
  if (process.platform !== "darwin") {
    require$$3$1.app.quit();
    win = null;
  }
});
require$$3$1.app.on("activate", function() {
  if (!require$$3$1.BrowserWindow.getAllWindows()?.length) createWindow();
});
require$$3$1.app.whenReady().then(function() {
  createWindow();
});
