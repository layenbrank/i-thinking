-- 冻结快照：v1 schema（等价于 apps/client/src-tauri/crates/database/migrations/migrations_v001.rs）
-- 由 Prisma 迁移生成，仅用于 scripts/check-schema-parity.mjs 的对照；
-- 不要修改，也不要作为建表来源（建表由 drizzle/migrations 负责）。
...
CREATE TABLE "aiWorkspaceFolder" (
    ...
    "createdAt" BIGINT NOT NULL,
    "updatedAt" BIGINT NOT NULL,
    CONSTRAINT "aiWorkspaceFolder_workspaceID_fkey" FOREIGN KEY ("workspaceID") REFERENCES "aiWorkspace" ("id") ON DELETE CASCADE ON UPDATE NO ACTION
);
...
CREATE TABLE "aiSession" (
    ...
    "createdAt" BIGINT NOT NULL,
    "updatedAt" BIGINT NOT NULL,
    CONSTRAINT "aiSession_workspaceID_fkey" FOREIGN KEY ("workspaceID") REFERENCES "aiWorkspace" ("id") ON DELETE SET NULL ON UPDATE NO ACTION
);
...
CREATE TABLE "aiMessage" (
    ...
    "createdAt" BIGINT NOT NULL,
    "updatedAt" BIGINT NOT NULL,
    CONSTRAINT "aiMessage_sessionID_fkey" FOREIGN KEY ("sessionID") REFERENCES "aiSession" ("id") ON DELETE CASCADE ON UPDATE NO ACTION
);
...
CREATE TABLE "asset" (
    ...
    "kind" TEXT,
    "hash" TEXT,
    "sha" TEXT NOT NULL DEFAULT 'sha256',
    "size" BIGINT,
    ...
    "metadata" TEXT,
    "status" TEXT NOT NULL DEFAULT '001',
...
CREATE TABLE "magneticTile" (
    ...
    "updatedAt" BIGINT NOT NULL,
    "createdAt" BIGINT NOT NULL,
    CONSTRAINT "magneticTile_mirrorID_fkey" FOREIGN KEY ("mirrorID") REFERENCES "mirror" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "calendar" (
    ...
    "createdAt" BIGINT NOT NULL,
    "updatedAt" BIGINT NOT NULL,
    CONSTRAINT "calendar_reminderID_fkey" FOREIGN KEY ("reminderID") REFERENCES "reminder" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "aiWorkspace_archivedAt_idx" ON "aiWorkspace"("archivedAt");

-- CreateIndex
CREATE INDEX "aiWorkspaceFolder_workspaceID_idx" ON "aiWorkspaceFolder"("workspaceID");

-- CreateIndex
CREATE INDEX "aiSession_workspaceID_idx" ON "aiSession"("workspaceID");

-- CreateIndex
CREATE INDEX "aiSession_updatedAt_idx" ON "aiSession"("updatedAt");
...
-- CreateIndex
CREATE INDEX "asset_filePath_idx" ON "asset"("filePath");

-- CreateIndex
CREATE INDEX "magneticTile_mirrorID_idx" ON "magneticTile"("mirrorID");

-- CreateIndex
CREATE INDEX "magneticTile_collectionID_idx" ON "magneticTile"("collectionID");

-- CreateIndex
CREATE INDEX "magneticTile_component_idx" ON "magneticTile"("component");

-- CreateIndex
CREATE INDEX "overlay_archivedAt_idx" ON "overlay"("archivedAt");
...
-- CreateIndex
CREATE INDEX "reminder_fireTime_idx" ON "reminder"("fireTime");

-- CreateIndex
CREATE INDEX "reminder_enabled_idx" ON "reminder"("enabled");

-- CreateIndex
CREATE INDEX "reminder_archivedAt_idx" ON "reminder"("archivedAt");

-- CreateIndex
CREATE INDEX "calendar_startAt_idx" ON "calendar"("startAt");

-- CreateIndex
CREATE INDEX "calendar_reminderID_idx" ON "calendar"("reminderID");
