...
# PACKAGE DETAILS
OutFile "installer-${PRODUCT_VERSION}.exe"
Name "${PRODUCT_NAME}"
...
VIAddVersionKey FileDescription "${PRODUCT_NAME} Description" ; file description
...
Section "section_name" SEC01
	...
	File "..\release\0.0.0\i-thinking-0.0.0-Setup.exe"
SectionEnd
